...
p_leftBook2 = [140, 100 , -80, 140, 90]
p_left2Book2 = [150, 180, 10, 20, 90]  #z  Left position
...
# Positions for different actions for Book 3
p_leftBook3 = [165, 100 , -80, 140, 90]
p_left2Book3 = [150, 180, 10, 20, 90]  # Left position
p_rightBook3 = [0, 80, 50, 50, 90]   # Right position
p_topBook3 = [90, 80, 50, 50, 90]    # Top (transition) position
p_restBook3 = [90, 90, 90, 0, 90]    # Rest position
...
# Function to move object from left to right for book3
def move_object_left_to_rightBook3():
    global arm_moving
    ...
    try:
        # Move to left position to pick object
        arm_clamp_block(0)  # Open clamp
        arm_move(p_left2Book3, 2000)
        arm_move(p_leftBook3, 2000)  # Move to left position
        arm_clamp_block(1)  # Clamp object
        ...
        # Move to right position
        arm_move(p_rightBook3, 2000)

        # Release object
        arm_clamp_block(0)

        # Return to rest position
        arm_move(p_topBook3, 2000)
        arm_move(p_restBook3, 2000)
            ...
            if bbox is not None:
                ...
                if data:
                    ...
                    if data != processed_qr:
                        ...
                        elif "danpink.com" in data:
                            move_object_left_to_rightBook3()
